...
import { Trophy, CircleCheck, CircleX, Image as ImageIcon } from "lucide-react";
    ...
    return (
        <DashboardLayout>
            <div className="space-y-6">
                ...
                <div>
                    <h1 className="text-3xl font-display text-foreground">🖼️ Image Game</h1>
                    <p className="text-muted-foreground font-body">
                        Mira la imagen y elige la palabra correcta en inglés.
                    </p>
                </div>
                    ...
                    <Card className="shadow-card border-0">
                        ...
                        <CardContent className="space-y-6">
                            <div className="space-y-4">
                                <p className="text-muted-foreground font-body">
                                    ¿Qué palabra en inglés corresponde a esta imagen?
                                </p>

                                <img
                                    src={currentWord.image}
                                    alt={currentWord.spanish}
                                    className="w-full max-w-xl h-64 object-cover rounded-xl shadow-sm"
                                />
                            </div>
